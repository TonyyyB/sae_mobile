...
class FavorisRestaurantScreen extends StatefulWidget {
  const FavorisRestaurantScreen({super.key});

  @override
  State<FavorisRestaurantScreen> createState() =>
      _FavorisRestaurantScreenState();
}

class _FavorisRestaurantScreenState extends State<FavorisRestaurantScreen> {
